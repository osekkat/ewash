...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "admin.not_configured.body": "Ajoutez ADMIN_PASSWORD et ADMIN_SESSION_SECRET pour activer le portail.",
    ...
    "en": {
        ...
        "admin.not_configured.body": "Set ADMIN_PASSWORD and ADMIN_SESSION_SECRET to enable the portal.",
        "status.draft": "Draft",
