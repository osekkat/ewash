...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "admin.dashboard.placeholder": "Réservations, clients, prix et promos sont disponibles. Les prochains lots couvriront rappels, fermetures, créneaux, centres et textes.",
        ...
        "admin.next.pages": "Pages réservations / clients / prix / promos",
        ...
        "admin.promos.discount_help": "Saisissez uniquement les prix remisés souhaités. Les champs vides utiliseront les tarifs publics.",
    ...
    "en": {
        ...
        "admin.dashboard.placeholder": "Bookings, customers, prices, and promos are available. Next batches cover reminders, closures, time slots, centers, and copy.",
        ...
        "admin.next.pages": "Bookings / customers / prices / promos pages",
        ...
        "admin.promos.discount_help": "Enter only the discounted prices you want. Blank fields use public prices.",
